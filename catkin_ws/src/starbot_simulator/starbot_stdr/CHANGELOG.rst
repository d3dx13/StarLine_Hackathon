^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package starbot_stdr
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

2.2.3 (2017-09-18)
------------------
* add turtlebot_navigation as dependency and fix amcl.launch.xml include path in starbot_stdr
...
* add stdr_resources as run_depend closes `#38 <https://github.com/turtlebot/starbot_simulator/issues/38>`_
* correct run_depend for stdr fixes `#37 <https://github.com/turtlebot/starbot_simulator/issues/37>`_
