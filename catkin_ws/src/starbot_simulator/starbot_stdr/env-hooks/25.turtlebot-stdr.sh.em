# Set some sane defaults for the turtlebot stdr launch environment
##Documentation:
...
: ${TURTLEBOT_STDR_MAP_FILE:=`rospack find starbot_stdr`/maps/sparse_obstacles.yaml}
# Exports
export TURTLEBOT_STDR_MAP_FILE
