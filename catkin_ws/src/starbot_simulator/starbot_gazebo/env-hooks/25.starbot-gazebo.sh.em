...
: ${TURTLEBOT_GAZEBO_MAP_FILE:=`rospack find starbot_gazebo`/maps/playground.yaml}
: ${TURTLEBOT_GAZEBO_WORLD_FILE:=`rospack find starbot_gazebo`/worlds/playground.world}
